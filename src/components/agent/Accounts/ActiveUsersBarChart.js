    ...
    return (
      <Card className="h-100 bg-gradient">
        <CardHeader className="bg-transparent">
          <h5 className="text-white">Active Devices Today</h5>
        ...
        <CardBody className="text-white fs--1">
          ...
          <ListGroup flush className="mt-4">
            ...
            <ListGroupItem
              ...
              style={{ borderColor: listItemBorderColor }}
            >
              <p className="mb-0">John Deaux - Desktop</p>
            ...
            <ListGroupItem
              ...
              style={{ borderColor: listItemBorderColor }}
            >
              <p className="mb-0">John Deaux - iPhone</p>
              <p className="mb-0">San Diego, CA</p>
            </ListGroupItem>
            <ListGroupItem
              ...
              style={{ borderColor: listItemBorderColor }}
            >
              <p className="mb-0">John Wick - Burner</p>
              <p className="mb-0">Shadyville, OK</p>
            </ListGroupItem>
            <ListGroupItem
              className="bg-transparent d-xxl-flex justify-content-between px-0 py-1 d-none"
              style={{ borderColor: listItemBorderColor }}
            >
              <p className="mb-0">Jane Deaux - iPhone</p>
              <p className="mb-0">San Diego, CA</p>
            </ListGroupItem>
            <ListGroupItem
              className="bg-transparent d-flex justify-content-between px-0 py-1"
              style={{ borderColor: listItemBorderColor }}
            >
              <p className="mb-0">Jane Deaux - Desktop</p>
              <p className="mb-0">San Diego, CA</p>
            </ListGroupItem>
          </ListGroup>
        </CardBody>
